...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = {
	    ...
	    gallery_init: function gallery_init($) {
	        /*
	         * Swiper 2.7.0
	        ...
	        var Swiper = function Swiper(a, b) {
	            "use strict";
	            function c(a, b) {
	                return document.querySelectorAll ? (b || document).querySelectorAll(a) : (0, _jquery2['default'])(a, b);
	            }
	        ...
	        })(window.jQuery || window.Zepto), "undefined" != typeof module && (module.exports = Swiper), "function" == "function" && __webpack_require__(4) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	            "use strict";
	            return Swiper;
	    ...
	    bindEvent: function bindEvent() {
	        ...
	        this.jQueryFn(_jquery2['default']);
	        this.jssor_1_slider_init();
	        this.gallery_init(_jquery2['default']);
	...
	_utilMethodEs6.utilMethods.ajax('temp.html', function (data) {
	    ...
	    (0, _jquery2['default'])('img').each(function (i, n) {
	        imgArr.push((0, _jquery2['default'])(n).data('src'));
	    });
	    var prec = (0, _utilMethodEs6.$)('.prec');
	    _utilMethodEs6.utilMethods.loading(imgArr, function (p) {
	        prec.innerHTML = Math.round(p * 100) + '%';
	    }, function () {

	        (0, _jquery2['default'])('#mask').addClass('hide');
	        (0, _utilMethodEs6.$)('.loading').classList.add('hide');
	        (0, _jquery2['default'])('img').each(function (i, n) {
	            (0, _jquery2['default'])(n).attr('src', (0, _jquery2['default'])(n).data('src'));
	        });
