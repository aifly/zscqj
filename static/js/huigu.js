...
/***/ function(module, exports, __webpack_require__) {
	...
	var data = {
	    ...
	    year: (0, _jquery2['default'])('#fly-main .year'),
	    sh: (0, _jquery2['default'])('#s-h'),
	    sliderContainer: (0, _jquery2['default'])('#fly-main .fly-slider-container'),
	    leftFill: (0, _jquery2['default'])("#bg .left")
	};
	...
	var util = {
	    init: function init() {
	        ...
	        (0, _jquery2['default'])(window).on('resize', function () {
	            ...
	            var k = width <= 1366 ? 200 : 100;
	            _this.setSize(width, height, k);
	            _this.setDefault(width);
	        });
	        this.bindEvent();
	    ...
	    setSize: function setSize() {
	        ...
	        var k = arguments.length <= 2 || arguments[2] === undefined ? 100 : arguments[2];

	        (0, _jquery2['default'])("#fly-main").height(height - k).css({ marginTop: k / 2 });

	        var h = (0, _jquery2['default'])('.time-line-container').height();

	        var sh = (0, _jquery2['default'])("#s-h"),
	            imgW = sh.width(),
	            imgH = sh.height(),
	            sliderC = (0, _jquery2['default'])('.fly-slider-container');

	        sliderC.height(h).width(imgW * sliderC.height() / imgH);

	        (0, _jquery2['default'])('.fly-slider-container ul li').height(h);

	        this.h = h;

	        data.leftFill.width((0, _jquery2['default'])("#fly-main .left-nav").width() + (0, _jquery2['default'])("#fly-main .left-nav").offset().left);
	    ...
	    initSlider: function initSlider() {
	        ...
	        (0, _jquery2['default'])('.fly-slider-container ul').css({ 'transform': 'translate3d(0,0,0)' });
	        year.removeClass('active');
	        year.eq(0).addClass("active");
	    },

	    slider: function slider(iNow, year, index, last) {
	        ...
	        (0, _jquery2['default'])('.fly-slider-container ul').css({ 'transform': 'translate3d(0,-' + iNow * this.h + 'px,0)' });
	    },
	    ...
	    bindEvent: function bindEvent() {
	        ...
	        var year = (0, _jquery2['default'])("#fly-main .year");

	        (0, _jquery2['default'])('body').on('click', function (e) {
	            var $Target = (0, _jquery2['default'])(e.target);
	            if ($Target.hasClass('year') || $Target.parents('.year').hasClass('year')) {
	                var target = $Target.hasClass('year') ? $Target : $Target.parents('.year');
	                var index = target.index();
	                if (index === iNow) return;
	                iNow = index;
	                //this.setTrantionDuration(index, last);
	                _this2.slider(index, year, index, last);
	                last = index;
	            }
	        });

	        var len = (0, _jquery2['default'])('.fly-slider-container ul li').size();
	        ...
	        (0, _jquery2['default'])(window).on('keydown', function (e) {
	            ...
	            if (code === 38) {
	                ...
	                iNow--;
	                iNow < 0 && (iNow = 0);
	                _this2.slider(iNow, year, iNow, last);
	    ...
	    setTrantionDuration: function setTrantionDuration(index, last) {
	        var dis = Math.abs(index - last);
	        isNaN(dis) && (dis = 1);
	        (0, _jquery2['default'])('.fly-slider-container ul').css({ 'transitionDuration': dis * 500 + 'ms' });
	        (0, _jquery2['default'])('.fly-slider-container ul').css({ '-webkit-transitionDuration': dis * 500 + 'ms' });
	    },
	    setDefault: function setDefault() {
	        var width = arguments.length <= 0 || arguments[0] === undefined ? data.viewWidth : arguments[0];

	        (0, _jquery2['default'])('html').css({ fontSize: width / 10 });
	    }

	};
	(0, _jquery2['default'])('#temp').load('temp.html', function (e) {
